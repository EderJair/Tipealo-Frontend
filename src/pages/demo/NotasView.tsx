      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
        ...
        <div className="md:col-span-2 bg-white">
          ...
          <div className="divide-y divide-black/4">
            {fiados.map(f => (
              <div key={f.name} className="px-4 md:px-5 py-3 flex items-center gap-3 hover:bg-gray-50/50 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-gray-400 mt-0.5 truncate">{f.items}</p>
                </div>
                <div className="text-right shrink-0">
                  <p className="text-[1rem] font-bold text-black">S/ {f.amount.toFixed(2)}</p>
                  <p className="text-[10px] text-gray-400">
                    vence <span className={f.urgente ? 'text-red-500 font-semibold' : ''}>{f.vence}</span>
                  </p>
                </div>
                <button className="shrink-0 text-[11px] font-semibold text-[#0c61f3] hover:text-black transition-colors ml-1">
                  Cobrar
                </button>
              </div>
            ))}
        ...
        <div className="bg-white flex flex-col">
          <div className="px-4 md:px-5 py-3 md:py-4 border-b border-black/5 flex items-center justify-between">
            ...
            <button className="text-[11px] font-semibold text-[#0c61f3] hover:text-black transition-colors">+ Nota</button>
          </div>
          ...
          <div className="mx-3 md:mx-4 mb-3 md:mb-4 bg-black/90 px-4 py-3">
